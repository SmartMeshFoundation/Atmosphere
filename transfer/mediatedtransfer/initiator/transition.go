...
import (
	...
	mt "github.com/SmartMeshFoundation/Atmosphere/transfer/mediatedtransfer"
	"github.com/SmartMeshFoundation/Atmosphere/transfer/mediatedtransfer/mediator"
	"github.com/SmartMeshFoundation/Atmosphere/transfer/route"
	...
	*/
	...
	if state == nil {
		...
		*/
		...
		//todo fix, find a way to remove this identifier from atmosphere.Transfer2StateManager
